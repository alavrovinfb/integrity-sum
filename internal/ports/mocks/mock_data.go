...
func (m *MockIHashStorage) Create(allHashData []*data.HashData, deploymentData *models.DeploymentData) error {
	m.ctrl.T.Helper()
...
func (m *MockIHashStorage) Get(dirPath string, deploymentData *models.DeploymentData) ([]*data.HashData, error) {
	m.ctrl.T.Helper()
...
// Get mocks base method.
func (m *MockIReleaseStorage) Get(deploymentData *models.DeploymentData) (*data.Release, error) {
	m.ctrl.T.Helper()
